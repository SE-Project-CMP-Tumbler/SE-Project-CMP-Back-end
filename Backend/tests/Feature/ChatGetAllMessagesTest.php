...
class ChatGetAllMessagesTest extends TestCase
{
    use RefreshDatabase;

    protected $endPoint = '/api/chat/messages/';
    ...
    {
        $response = $this->postJson($this->endPoint . $this->chatRoomGID->id, [
            'from_blog_id' => $this->blogA->id,
        ], Config::JSON);
    ...
    {
        $response = $this->postJson($this->endPoint . 'abc', [
            'from_blog_id' => $this->blogA->id,
        ], array_merge(Config::JSON, [
            'Authorization' => 'Bearer ' . $this->actA,
        ]));
    ...
    public function testSendingNotExistChatRoomID()
    {
        ...
        $response = $this->postJson($this->endPoint . $lastChatRoomGID, [
            'from_blog_id' => $this->blogA->id,
        ], array_merge(Config::JSON, [
            'Authorization' => 'Bearer ' . $this->actA,
        ]));
    ...
    public function testSendingOnChatRoomIDForOtherBlogs()
    {
        ...
        $response = $this->postJson($this->endPoint . $tmp->id, [
            'from_blog_id' => $this->blogA->id,
        ], array_merge(Config::JSON, [
            'Authorization' => 'Bearer ' . $this->actA,
        ]));
